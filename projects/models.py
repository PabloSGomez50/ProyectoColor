...
class User(AbstractUser):
    ...
    profile_img = models.ImageField(upload_to=user_dir_path, blank=True)
...
class Skill(models.Model):
    name = models.CharField(max_length=64)
    icon = models.ImageField(upload_to='icon_skills')
...
class Comment(models.Model):
    ...
    def __str__(self):
        return f'{self.user} comment in {self.project}'
